...
public class CustomCssSelector {
	...
	public static void main(String[] args) {
		...
		//INTERVIEW QUESTION
		//how will you use normalize space concept?Suppose india contains space
		//HTMLTag[normalize-space()='India']
...
//		input#username.form-control.private-form__control.login-email
		...
		//INTERVIEW QUESTION1
		//Which of the follwing are valid locator strategies?
		...
		//a[@href]		--xpath, give some links having href property!
		
		
		// input[placeholder='First Name']#input-firstname
		// input#input-firstname[placeholder='First Name']
		
		//text in css: not applicable, deprecated in latest version
		...
		//starts-with in css:
		//tag[attr^='value'] --starts-with---  ^ spl character is called 'caret'
		
		//ends-with in css:
		//tag[attr$='value'] --ends-with--- dollar character in ends with
		// input[id$='name']
...
//		select#Form_getForm_Country  option:nth-child(4n)
		...
		//comma in css:
		//INTERVIEW QUESTION;
		//How to check mandatory elements present on page if doing sanity check?
